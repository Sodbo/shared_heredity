...
path_to_output_directory <- '/mnt/polyomica/projects/shared_heredity/data/02_Lipids/three_traits/GIP/00_raw_data/'
...
gip1 <- read.table('/mnt/polyomica/projects/shared_heredity/data/02_Lipids/three_traits/GIP1.txt', row.names = 1)
