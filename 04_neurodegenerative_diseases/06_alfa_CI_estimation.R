...
se <-as.matrix(read.table('~/polyomica/projects/shared_heredity/data/neurodegenerative_diseases/several_traits/gene_cov_se_matrix.txt', check.names=F))
...
write.table(res,'~/polyomica/projects/shared_heredity/data/neurodegenerative_diseases/several_traits/CIs_for_3_traits.txt',quote=F)
